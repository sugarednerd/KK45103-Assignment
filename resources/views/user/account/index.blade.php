...
@section('content')
<div class="container pages-content mt-5 otherpages">
  <h1 class="mb-4">User Account Management</h1>
    ...
    <div class="col-lg-8">
      <div class="card mb-4 h-100">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-sm-12">
              <a href="{{ route('user.account.edit') }}" class="btn btn-primary">Edit Profile</a>
            </div>
          </div>
        </div>
      </div>
